...
function ManageOrders() {
  ...
  useEffect(() => {
    const fetchOrders = async () => {
      try {
        ...
        // ✔ Using your central axios instance
  ...
  const handleStatusChange = async (orderId, newStatus) => {
    ...
    try {
      // Correct axios instance + correct URL
      const response = await api.post(`/Order/admin/update-status/${orderId}`, {
        newStatus,
      });
              ...
              >
                ...
                <p className="text-gray-600 mb-6 text-center">
                  ...
                  <span className="font-bold text-red-600">
                    {statusData.find((s) => s.label === selectedStatus)
                      ?.value || 0}
                  </span>{" "}
